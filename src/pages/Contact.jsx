...
const Contact = () => {
    ...
    const SectionHeader = ({ title, subtitle }) => (
        <div className="flex flex-col items-center justify-center text-center mb-12 md:mb-16">
            ...
            <h2 className="font-['Cinzel',serif] text-3xl md:text-4xl lg:text-5xl text-[#4A1521] font-bold tracking-wide mb-5 uppercase">
                {title}
            </h2>
            <div className="flex items-center justify-center gap-2 opacity-80">
                <div className="w-10 md:w-16 h-[1px] bg-[#C8A97E]"></div>
    ...
    return (
        <div className="bg-[#FDFBF7] min-h-screen font-['Montserrat',sans-serif] overflow-x-hidden">

            {/* ==========================================
                1. HERO SECTION (Full Page with Glass Box)
                ========================================== */}
            <section className="relative w-full h-screen flex flex-col items-center justify-center pt-24 px-4 md:px-6 overflow-hidden">
                ...
                >
                    <h1 className="font-['Cinzel',serif] text-[32px] sm:text-5xl md:text-6xl lg:text-[75px] text-[#4A1521] font-bold mb-4 md:mb-6 leading-[1.1] w-full break-words">
                        CONTACT <br className="hidden sm:block" /> US
                    </h1>
                    ...
                    <p className="text-[#4A1521] text-[13px] sm:text-sm md:text-lg font-bold max-w-xl mx-auto mb-8 md:mb-10 leading-relaxed px-2">
                        We'd love to hear from you. Whether you're planning your dream bridal outfit, a custom couture design, or a boutique production order.
                    </p>

                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
                        <Link to="/appointment" className="w-full sm:w-auto bg-[#4A1521] text-white px-8 py-3.5 text-xs font-bold tracking-[0.2em] uppercase rounded-sm border border-[#4A1521] hover:bg-white hover:text-[#4A1521] transition-all duration-300 flex items-center justify-center gap-2 shadow-sm">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                            BOOK APPOINTMENT
                        </Link>
                        <a href="https://wa.me/923099853117" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-white/70 text-[#4A1521] px-8 py-3.5 text-xs font-bold tracking-[0.2em] uppercase rounded-sm border border-white/60 hover:bg-[#4A1521] hover:text-white hover:border-[#4A1521] transition-all duration-300 flex items-center justify-center gap-2 shadow-sm">
          ...
          ========================================== */}
            <section className="py-16 md:py-24 px-4 md:px-8 lg:px-20 max-w-[1400px] mx-auto relative z-20">
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="lg:col-span-5 h-full bg-white border border-[#C8A97E]/30 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] p-6 sm:p-8 md:p-12 relative overflow-hidden group hover:border-[#C8A97E]/60 transition-colors duration-500">
                        {/* Background Accents for Luxury Feel */}
                        <div className="absolute top-0 right-0 w-40 h-40 bg-[#C8A97E]/10 rounded-full blur-3xl group-hover:bg-[#C8A97E]/20 transition-all duration-700 pointer-events-none"></div>
                        <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#4A1521]/5 rounded-full blur-2xl pointer-events-none"></div>
                    ...
                    <motion.div variants={itemVariants} className="lg:col-span-7 h-full bg-white border border-[#C8A97E]/30 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] p-6 sm:p-8 md:p-12 hover:border-[#C8A97E]/60 transition-colors duration-500 flex flex-col justify-center">
                        <h3 className="font-['Cinzel',serif] text-[#4A1521] text-xl md:text-2xl font-bold tracking-[0.15em] text-center mb-4">
                            SEND US A MESSAGE
                        </h3>
                        ...
                        <form className="space-y-4 md:space-y-5">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
                                <div className="relative group">
                                    <input
                                        ...
                                        className="w-full bg-[#FDFBF7] placeholder-[#A0A0A0] text-[#4A1521] px-5 py-3.5 md:py-4 text-[13px] outline-none rounded-md border border-[#C8A97E]/40 focus:border-[#4A1521] focus:ring-1 focus:ring-[#4A1521]/20 transition-all shadow-sm hover:border-[#C8A97E]"
                                    />
                                </div>
                                <div className="relative group">
                                    <input
                            ...
                            <div className="relative group">
                                <select className="w-full bg-[#FDFBF7] text-[#555555] px-5 py-3.5 md:py-4 text-[13px] outline-none rounded-md border border-[#C8A97E]/40 focus:border-[#4A1521] focus:ring-1 focus:ring-[#4A1521]/20 transition-all shadow-sm appearance-none cursor-pointer hover:border-[#C8A97E]">
                            ...
                            <div className="relative group">
                                <textarea
                                    ...
                                    rows="5"
                                    className="w-full bg-[#FDFBF7] placeholder-[#A0A0A0] text-[#4A1521] px-5 py-3.5 md:py-4 text-[13px] outline-none rounded-md border border-[#C8A97E]/40 focus:border-[#4A1521] focus:ring-1 focus:ring-[#4A1521]/20 transition-all shadow-sm resize-none hover:border-[#C8A97E]"
                                ></textarea>
                            </div>

                            <button
                                type="button"
                                className="w-full bg-[#4A1521] text-white px-8 py-4 text-[12px] md:text-[13px] font-bold tracking-[0.2em] uppercase rounded-md border border-[#4A1521] hover:bg-transparent hover:text-[#4A1521] active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2 mt-2 shadow-md hover:shadow-none"
                            >
                                SEND MESSAGE
          ...
          ========================================== */}
            <section className="py-16 md:py-24 max-w-[1400px] mx-auto overflow-hidden">
                <div className="px-6 md:px-10">
                    <SectionHeader title="WHY CLIENTS CHOOSE US" subtitle="The Studio Difference" />
                </div>
                ...
                <div className="w-full relative mt-8 md:mt-12">
                    <motion.div
                        ...
                        whileInView="show"
                        viewport={{ once: true, amount: 0.1 }}
                        className="flex md:grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 overflow-x-auto snap-x snap-mandatory px-6 md:px-10 pb-10 pt-2 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
                    >
                        {/* Card 1 */}
                        <motion.div variants={itemVariants} className="w-[85vw] sm:w-[320px] md:w-full flex-none snap-center bg-white border border-[#C8A97E]/30 rounded-xl p-6 md:p-8 text-center shadow-[0_4px_15px_rgba(0,0,0,0.03)] hover:shadow-[0_15px_30px_rgba(74,21,33,0.08)] hover:border-[#C8A97E]/80 hover:-translate-y-2 transition-all duration-500 group whitespace-normal">
                            <div className="w-14 h-14 md:w-16 md:h-16 mx-auto mb-5 md:mb-6 rounded-full bg-[#FDFBF7] border border-[#C8A97E]/50 flex items-center justify-center text-[#C8A97E] group-hover:bg-[#4A1521] group-hover:border-[#4A1521] group-hover:text-[#C8A97E] transition-all duration-500 shadow-sm">
                            ...
                            <div className="w-8 h-[1px] bg-[#C8A97E]/50 mx-auto mb-4 group-hover:w-16 group-hover:bg-[#C8A97E] transition-all duration-500"></div>
            ...
            <section className="py-16 px-4 md:px-10 max-w-[1400px] mx-auto">
                <SectionHeader title="VISIT OUR BOUTIQUE" subtitle="Find Us Here" />
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.8 }}
                    className="w-full rounded-2xl overflow-hidden border border-[#C8A97E]/30 shadow-[0_10px_40px_rgba(74,21,33,0.06)] relative bg-white"
                >
            ...
            <section className="py-16 md:py-24 px-4 md:px-10 max-w-[1200px] mx-auto">
                <SectionHeader title="GOT QUESTIONS?" subtitle="Frequently Asked" />

                <motion.div layout className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-4 items-start">
                    <AnimatePresence>
                        {faqData.map((faq, index) => (
                            <motion.div
                                ...
                                className={`relative bg-white group rounded-[2px] transition-all duration-500 cursor-pointer border ${openFaq === index
                                        ? 'border-[#C8A97E] shadow-[0_15px_30px_rgba(74,21,33,0.08)]'
                                        : 'border-[#C8A97E]/20 shadow-sm hover:border-[#C8A97E]/60 hover:shadow-md'
                                    }`}
                            >
                                {/* Luxury Accent Line */}
                                <div className={`absolute left-0 top-0 bottom-0 w-1 transition-colors duration-500 ${openFaq === index ? 'bg-[#C8A97E]' : 'bg-transparent group-hover:bg-[#C8A97E]/40'}`}></div>

                                {/* Question Header */}
                                <div className="flex items-center justify-between p-5 md:p-6 pl-6 md:pl-8">
                                    <span className={`font-semibold text-[13px] md:text-[14px] leading-snug tracking-wide pr-4 transition-colors duration-300 ${openFaq === index ? 'text-[#C8A97E]' : 'text-[#4A1521]'}`}>
                                        {faq.question}
                                    </span>

                                    {/* Minimalist Icon */}
                                    <div className={`flex-shrink-0 w-6 h-6 rounded-full border flex items-center justify-center transition-all duration-500 ${openFaq === index
            ...
            {/* ==========================================
                ...
                ========================================== */}
            <section
                className="relative w-full py-24 md:py-32 px-4 overflow-hidden flex flex-col items-center justify-center bg-fixed bg-cover bg-[center_top]"
                style={{ backgroundImage: `url('/image20.webp')` }}
            >
                {/* Dark Maroon Overlay matching the reference */}
                <div className="absolute inset-0 bg-[#3A0F18]/70 z-0"></div>

                <div className="relative z-10 max-w-4xl mx-auto text-center px-2">
                    <h2 className="font-['Cinzel',serif] text-3xl md:text-4xl lg:text-5xl text-white font-bold tracking-widest mb-4 md:mb-6 uppercase leading-tight">
                    ...
                    <p className="text-[#FDFBF7]/90 text-[13px] md:text-base leading-relaxed max-w-2xl mx-auto mb-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
                        <Link to="/appointment" className="w-full sm:w-auto bg-[#C8A97E] text-white px-8 py-3.5 text-[11px] md:text-xs font-bold tracking-[0.2em] uppercase rounded-sm border border-[#C8A97E] hover:bg-transparent hover:text-[#C8A97E] transition-all duration-300 flex items-center justify-center gap-2">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                            BOOK APPOINTMENT
                        </Link>
                        <a href="https://wa.me/923099853117" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-transparent text-white px-8 py-3.5 text-[11px] md:text-xs font-bold tracking-[0.2em] uppercase rounded-sm border border-[#C8A97E] hover:bg-[#C8A97E] transition-all duration-300 flex items-center justify-center gap-2">
                            <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M12.012 2c-5.506 0-9.989 4.478-9.99 9.984a9.964 9.964 0 001.333 4.976L2 22l5.187-1.337a9.982 9.982 0 004.825 1.25H12.012c5.506 0 9.989-4.479 9.989-9.985S17.518 2 12.012 2zm5.722 14.34c-.242.684-1.385 1.29-1.937 1.343-.523.051-1.18.258-3.953-.889-3.344-1.383-5.513-4.81-5.681-5.034-.168-.225-1.355-1.802-1.355-3.435 0-1.632.846-2.434 1.144-2.738.298-.304.646-.381.86-.381.215 0 .43.003.616.012.196.009.46-.077.72.552.268.648.878 2.146.953 2.298.076.151.127.327.025.53-.102.201-.153.327-.305.504-.153.176-.322.381-.458.504-.152.14-.316.294-.136.607.18.312.802 1.328 1.722 2.148 1.19.1.066 1.765 1.579 1.968 1.815.202.241.196.425.127.63-.068.204-.32.613-.655.855-.336.241-.673.303-.92.24-.247-.061-1.464-.54-1.464-.54s-.308-.242-.684-.242z" /></svg>
