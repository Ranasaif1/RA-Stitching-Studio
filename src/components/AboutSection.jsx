...
// import AboutUs from '../pages/AboutUs'; <-- Iski yahan zaroorat nahi thi isliye hata diya
                ...
                <div className="max-w-[1400px] mx-auto flex items-center justify-between gap-16 relative z-10">
                    ...
                    <div className="w-[50%] space-y-6 text-left relative z-20 pr-12">
                        ...
                        <div className={`pt-4 transform transition-all duration-1000 delay-[1300ms] ease-out ${isVisibleDesktop ? 'translate-x-0 opacity-100' : 'translate-x-32 opacity-0'}`}>
                            <Link 
                                to="/about-us" 
                                className="bg-[#4A1521] text-white px-8 py-4 text-[11px] font-bold tracking-[0.2em] uppercase rounded-sm hover:bg-transparent hover:text-[#4A1521] border border-[#4A1521] transition-all duration-300 shadow-xl hover:shadow-none inline-block hover:-translate-y-1 relative z-50 pointer-events-auto"
                            >
                                READ OUR STORY
                            </Link>
                        </div>
                ...
                <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center">
                    ...
                    >
                        ...
                        <div className="w-[85vw] md:w-[70vw] flex-shrink-0 space-y-5 text-center">
                            ...
                            ========================================== */}
                            <div className="pt-2 relative z-[99]">
                                <Link
                                    to="/about-us"
                                    className="relative z-[99] bg-[#4A1521] text-white px-6 py-3.5 text-[10px] font-bold tracking-[0.2em] uppercase rounded-sm border border-[#4A1521] shadow-xl inline-block hover:bg-transparent hover:text-[#4A1521] transition-all duration-300 cursor-pointer pointer-events-auto"
                                >
                                    READ OUR STORY
                                </Link>
                            </div>
