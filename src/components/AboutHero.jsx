...
const HeroSection = () => {
    ...
    return (
        <section
            ...
            style={{ backgroundImage: "url('/image14.png')" }}
        >
            ...
            */}
            <div className="absolute inset-y-0 left-0 w-[85%] md:w-[85%] lg:w-[70%] bg-gradient-to-r from-[#FDFBF7] from-60% via-[#FDFBF7]/50 to-transparent z-10 pointer-events-none"></div>
                ...
                <div className="max-w-[650px] flex flex-col items-start">
                    ...
                    <div className={`transform transition-all duration-1000 delay-150 ease-out ${isMounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                        <h2 className="font-['Cinzel',serif] text-[15px] md:text-[22px] lg:text-[25px] text-[#C8A97E] tracking-[0.25em] md:tracking-[0.3em] font-semibold uppercase mt-3 md:mt-4 mb-3">
                            Crafting Elegance. Continuing a Legacy.
                        </h2>
                    </div>
                    ...
                    {/* Paragraph (Services list replaced with simple animated text) */}
                    <div className={`mb-10 transform transition-all duration-700 ease-out ${isMounted ? 'translate-x-0 opacity-100' : '-translate-x-8 opacity-0'}`} style={{ transitionDelay: '600ms' }}>
                        <p className="font-serif italic text-[19px] md:text-[26px] lg:text-[28px] text-[#4A1521] m-0">
                    ...
                    {/* Buttons Area */}
                    <div className={`flex flex-wrap gap-4 md:gap-6 items-center transform transition-all duration-1000 delay-[900ms] ease-out ${isMounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                        <a
                            href="#book"
            ...
            <div className={`absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-1.5 cursor-pointer transition-opacity duration-1000 delay-[1200ms] ${isMounted ? 'opacity-100' : 'opacity-0'}`}>
